/*
 * st_mcan_config.h  —  PDU board configuration for shared MCAN layer
 *
...
#define ST_MCAN_MY_MSG_ID    0x501U
#define ST_MCAN_PEER_MSG_ID  0x500U
#define ST_MCAN_MY_HB_ID     0x511U
#define ST_MCAN_PEER_HB_ID   0x510U

/* PDU status word bit definitions are in Shared/Inc/st_common.h */

/* -----------------------------------------------------------------------
 * Runtime telemetry IDs (PDU→RCU, runtime build only)
 * ----------------------------------------------------------------------- */
...
/* Runtime command IDs (RCU→PDU, runtime build only) */
