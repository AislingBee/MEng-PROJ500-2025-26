...
# Adjust this import to match your actual robot_command message type:
try:
    from custom_msgs.msg import RobotCommand  # type: ignore
    HAS_ROBOT_CMD = True
except ImportError:
    HAS_ROBOT_CMD = False

# Locate rcu_protocol relative to this file
