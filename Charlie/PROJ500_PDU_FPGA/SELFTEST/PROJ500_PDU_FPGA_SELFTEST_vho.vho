...
-- ldbanno -n VHDL -o PROJ500_PDU_FPGA_SELFTEST_vho.vho -w -neg -gui -msgset C:/Users/charl/Documents/TEMP BACKUPS/17.03.26/PROJ500 (Humanoid)/FPGA/PROJ500_PDU_FPGA/promote.xml PROJ500_PDU_FPGA_SELFTEST.ncd 
-- Netlist created on Fri Apr 17 00:30:17 2026
-- Netlist written on Fri Apr 17 00:30:21 2026
...
-- entity SLICE_1
  ...
  begin
    SPARE_OUT_1_8: lut40002
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    SPARE_OUT_1_9: lut40003
...
-- entity SW_REMOTE_DISARMB
  ...
  begin
    SW_REMOTE_DISARM_pad: xo2iobuf0005
...
-- entity MCU_CMD_FAULTB
  ...
  begin
    MCU_CMD_FAULT_pad: xo2iobuf0005
...
-- entity SW_REMOTE_ARMB
  ...
  begin
    SW_REMOTE_ARM_pad: xo2iobuf0005
...
-- entity pdu_selftest_mxo2
  ...
  begin
    SLICE_0I: SLICE_0
      port map (D1=>SPARE_OUT_1_8, C1=>SPARE_OUT_1_9, B1=>SPARE_OUT_1_7, 
                A1=>SPARE_OUT_1_6, B0=>UV_c, A0=>VBUS_OV_c, F0=>SPARE_OUT_1_6, 
                F1=>SPARE_OUT_1_c);
    SLICE_1I: SLICE_1
      port map (D1=>SW_ARM_c, C1=>PRECHARGE_OK_c, B1=>MCU_CMD_FAULT_c, 
                A1=>OV_c, D0=>SW_COMPUTE_c, C0=>SW_REMOTE_ARM_c, 
                B0=>SW_RST_FAULT_c, A0=>SW_REMOTE_DISARM_c, F0=>SPARE_OUT_1_9, 
                F1=>SPARE_OUT_1_8);
    SLICE_2I: SLICE_2
      port map (D0=>MCU_CMD_ARM_c, C0=>MCU_ALIVE_c, B0=>ESTOP_OK_c, 
                A0=>FB_CLOSED_c, F0=>SPARE_OUT_1_7, F1=>VCC);
