...
(library Library_1
	...
	(symbolDef "AP2114HA-3.3TRG1" (originalName "AP2114HA-3.3TRG1")
	...
	(compDef "AP2114HA-3.3TRG1" (originalName "AP2114HA-3.3TRG1") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AP2114HA-3.3TRG1"))
		...
		(attr "<Hyperlink>" "https://www.diodes.com//assets/Datasheets/AP2114.pdf")
		(attr "<Component Height>" "1.8")
		(attr "<STEP Filename>" "AP2114HA-3.3TRG1.stp")
