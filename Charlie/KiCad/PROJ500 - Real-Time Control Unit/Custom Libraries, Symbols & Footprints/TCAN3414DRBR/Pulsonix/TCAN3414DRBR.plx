...
//19598565/1152530/2.50/9/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TCAN3414DRBR" (originalName "TCAN3414DRBR")
	...
	(compDef "TCAN3414DRBR" (originalName "TCAN3414DRBR") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "8" (pinName "STB") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "5" (pinName "SHDN") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TCAN3414DRBR"))
		...
		(attr "Mouser Part Number" "595-TCAN3414DRBR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TCAN3414DRBR?qs=2wMNvWM5ZX6YBBH9qF6w4g%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TCAN3414DRBR")
		(attr "Description" "CAN Interface IC 3.3-V CAN FD transceiver with shut-down and standby mode")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/tcan3413.pdf?ts=1714741551942&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252FTCAN3413")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "TCAN3414DRBR.stp")
