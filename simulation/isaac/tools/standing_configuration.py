...
# -----------------------------------------------------------------------------
# Standing pose config
# -----------------------------------------------------------------------------

# Adjust these names only if your runtime joint names differ.
STANDING_TARGETS_DEG = {
    # Left leg
    "l_hip_yaw_link_l_hip_pitch_joint": 0.0,
    "l_hip_pitch_link_l_hip_roll_joint": 0.0,
    "l_hip_roll_link_l_thigh_joint": -10.0,
    "l_thigh_link_l_shank_joint": 20.0,
    "l_shank_link_l_ankle_pitch_joint": -10.0,
    "l_ankle_pitch_link_l_ankle_roll_joint": 0.0,

    # Right leg
    "r_hip_yaw_link_r_hip_pitch_joint": 0.0,
    "r_hip_pitch_link_r_hip_roll_joint": 0.0,
    "r_hip_roll_link_r_thigh_joint": -10.0,
    "r_thigh_link_r_shank_joint": 20.0,
    "r_shank_link_r_ankle_pitch_joint": -10.0,
    "r_ankle_pitch_link_r_ankle_roll_joint": 0.0,
}
