...
# Smooth standing sim-to-real policy contract.
# Import this into:
#   - train_stand_smooth_s2r.py
#   - export_deployable_policy(...)
#   - smooth-standing deployment runners
#
# This keeps deployment-critical constants aligned between smooth-standing
# training and Thor deployment, while remaining structurally parallel to the
# base standing contract.


ACTION_SCALE: Final[tuple[float, ...]] = (
    0.065, 0.052, 0.0975, 0.13, 0.078, 0.052,
    0.065, 0.052, 0.0975, 0.13, 0.078, 0.052,
)
...
if ACTION_DIM != 12:
    raise RuntimeError(f"Smooth standing contract must use action dim 12, got {ACTION_DIM}")
...
class StandSmoothS2RPolicyContract:
...
CONTRACT: Final[StandSmoothS2RPolicyContract] = StandSmoothS2RPolicyContract()
