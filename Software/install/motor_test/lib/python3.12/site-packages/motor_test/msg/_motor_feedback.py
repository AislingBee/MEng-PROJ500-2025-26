...
class Metaclass_MotorFeedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from motor_test.msg import MotorFeedbackEntry
            if MotorFeedbackEntry.__class__._TYPE_SUPPORT is None:
                MotorFeedbackEntry.__class__.__import_type_support__()
...
class MotorFeedback(metaclass=Metaclass_MotorFeedback):
    ...
    _fields_and_field_types = {
        'motors': 'sequence<motor_test/MotorFeedbackEntry>',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['motor_test', 'msg'], 'MotorFeedbackEntry')),  # noqa: E501
    )
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, MotorFeedbackEntry) for v in value) and
                 True), \
                "The 'motors' field must be a set or sequence and each value of type 'MotorFeedbackEntry'"
        self._motors = value
