...
static const _MotorParam_type_support_symbol_names_t _MotorParam_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_test, msg, MotorParam)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motor_test, msg, MotorParam)),
  }
};
...
{
  return &::motor_test::msg::rosidl_typesupport_cpp::MotorParam_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motor_test, msg, MotorParam)() {
  return get_message_type_support_handle<motor_test::msg::MotorParam>();
}
