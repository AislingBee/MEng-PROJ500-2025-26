...
#include "motor_test/msg/detail/motor_feedback_entry__rosidl_typesupport_fastrtps_c.h"
...
using _MotorFeedbackEntry__ros_msg_type = motor_test__msg__MotorFeedbackEntry;
...
{
  const _MotorFeedbackEntry__ros_msg_type * ros_message = static_cast<const _MotorFeedbackEntry__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = motor_test__msg__MotorFeedbackEntry;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const motor_test__msg__MotorFeedbackEntry * ros_message = static_cast<const motor_test__msg__MotorFeedbackEntry *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_motor_test__msg__MotorFeedbackEntry(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  motor_test__msg__MotorFeedbackEntry * ros_message = static_cast<motor_test__msg__MotorFeedbackEntry *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_motor_test__msg__MotorFeedbackEntry(cdr, ros_message);
}

static uint32_t _MotorFeedbackEntry__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_motor_test__msg__MotorFeedbackEntry(
...
static size_t _MotorFeedbackEntry__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_motor_test__msg__MotorFeedbackEntry(
...
static message_type_support_callbacks_t __callbacks_MotorFeedbackEntry = {
  "motor_test::msg",
  "MotorFeedbackEntry",
...
static rosidl_message_type_support_t _MotorFeedbackEntry__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MotorFeedbackEntry,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motor_test, msg, MotorFeedbackEntry)() {
  return &_MotorFeedbackEntry__type_support;
}
