...
: ${AMENT_CURRENT_PREFIX:="/home/meng/meng/MEng-PROJ500-2025-26/Software/install/motor_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/motor_test/environment/pythonpath.sh"
